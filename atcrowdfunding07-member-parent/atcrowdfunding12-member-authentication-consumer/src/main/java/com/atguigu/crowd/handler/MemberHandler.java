...
public class MemberHandler {
    ...
    public String login(
        ...
        return "redirect:http://localhost:5243/auth/member/to/center/page";
    }
    ...
    public ResultEntity<String> sendMessage(@RequestParam("phoneNum") String phoneNum) {
        ...
        // 2.判断短信发送结果
        if(ResultEntity.SUCCESS.equals("SUCCESS")) {
            ...
            // ③调用远程接口存入Redis
            ResultEntity<String> saveCodeResultEntity = redisRemoteService.setRedisKeyValueRemoteWithTimeout(key, Integer.toString(code), 15, TimeUnit.MINUTES);
